...
export const matches: MatchSeed[] = [
  ...
  // ── 16AVOS (RONDA DE 32) ──────────────────────────────────────────────────
  { matchNumber: 73, stage: 'ROUND_OF_32', scheduledAt: new Date('2026-06-28T19:00:00Z'), venue: 'Los Angeles Stadium' },
  { matchNumber: 74, stage: 'ROUND_OF_32', scheduledAt: new Date('2026-06-29T20:30:00Z'), venue: 'Boston Stadium' },
  { matchNumber: 75, stage: 'ROUND_OF_32', scheduledAt: new Date('2026-06-30T01:00:00Z'), venue: 'Estadio Monterrey' },
  { matchNumber: 76, stage: 'ROUND_OF_32', scheduledAt: new Date('2026-06-29T17:00:00Z'), venue: 'Houston Stadium' },
  { matchNumber: 77, stage: 'ROUND_OF_32', scheduledAt: new Date('2026-06-30T21:00:00Z'), venue: 'New York/New Jersey Stadium' },
  { matchNumber: 78, stage: 'ROUND_OF_32', scheduledAt: new Date('2026-06-30T17:00:00Z'), venue: 'Dallas Stadium' },
  { matchNumber: 79, stage: 'ROUND_OF_32', scheduledAt: new Date('2026-07-01T01:00:00Z'), venue: 'Estadio Ciudad de México' },
  { matchNumber: 80, stage: 'ROUND_OF_32', scheduledAt: new Date('2026-07-01T16:00:00Z'), venue: 'Atlanta Stadium' },
  { matchNumber: 81, stage: 'ROUND_OF_32', scheduledAt: new Date('2026-07-02T00:00:00Z'), venue: 'San Francisco Bay Area Stadium' },
  { matchNumber: 82, stage: 'ROUND_OF_32', scheduledAt: new Date('2026-07-01T20:00:00Z'), venue: 'Seattle Stadium' },
  { matchNumber: 83, stage: 'ROUND_OF_32', scheduledAt: new Date('2026-07-02T23:00:00Z'), venue: 'Toronto Stadium' },
  { matchNumber: 84, stage: 'ROUND_OF_32', scheduledAt: new Date('2026-07-02T19:00:00Z'), venue: 'Los Angeles Stadium' },
  { matchNumber: 85, stage: 'ROUND_OF_32', scheduledAt: new Date('2026-07-03T03:00:00Z'), venue: 'BC Place Vancouver' },
  { matchNumber: 86, stage: 'ROUND_OF_32', scheduledAt: new Date('2026-07-03T22:00:00Z'), venue: 'Miami Stadium' },
  { matchNumber: 87, stage: 'ROUND_OF_32', scheduledAt: new Date('2026-07-04T01:30:00Z'), venue: 'Kansas City Stadium' },
  { matchNumber: 88, stage: 'ROUND_OF_32', scheduledAt: new Date('2026-07-03T18:00:00Z'), venue: 'Dallas Stadium' },
